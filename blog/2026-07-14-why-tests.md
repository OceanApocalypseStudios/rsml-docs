...
Before we get into the article, I want to inform you it will be much shorter than the last one, mostly because, currently, the focus is finishing [#60](https://github.com/OceanApocalypse/RedSeaMarkupLanguage/issues/60) and finally moving on to RSML's lexer and respective modularity system.
