---
id: "OceanApocalypseStudios.RSML.Sources.ReadOnlySpanBuffer.md"
managed-by: python-postprocessor
---

# Struct ReadOnlySpanBuffer
...
```csharp
public readonly Boolean CacheExists { get; }
```
...
```csharp
public readonly Boolean IsEmpty { get; }
```
...
```csharp
public readonly Int32 Length { get; }
```
...
<xref href="OceanApocalypseStudios.RSML.Sources.ReadOnlySpanBuffer.LineCount" data-throw-if-not-resolved="false"></xref> automatically builds cache if
no cached data exists. No <xref href="OceanApocalypseStudios.RSML.Sources.ReadOnlySpanBuffer.BuildCache" data-throw-if-not-resolved="false"></xref> calls
are necessary.
...
```csharp
public readonly Char? this[Int32 index] { get; }
```
...
```csharp
public readonly Char? this[SourceLocation location] { get; }
```
...
```csharp
public readonly Result<String> this[SourceSpan span] { get; }
```
...
```csharp
public readonly Result<Int32> CountUntilWhitespace(Int32 index)
```
...
```csharp
public readonly Boolean Equals(Char[]? other)
```
...
```csharp
public readonly Boolean Equals(IReadOnlyBuffer? other)
```
...
```csharp
public readonly Boolean Equals(ReadOnlyMemory<Char> other)
```
...
```csharp
public readonly Boolean Equals(ReadOnlySpan<Char> other)
```
...
```csharp
public readonly Boolean Equals(ReadOnlySpanBuffer other)
```

#### Parameters

`other` [ReadOnlySpanBuffer](OceanApocalypseStudios.RSML.Sources.ReadOnlySpanBuffer.md)
...
```csharp
public readonly Result<String> Slice(Int32 start, Int32 length)
```
...
### TryGetLineFromIndex\(Int32, scoped Span<Char\>\)
...
```csharp
public readonly Boolean TrySlice(Int32 start, Span<Char> slice)
```
...
```csharp
public readonly Boolean TrySlice(SourceSpan sourceSpan, Span<Char> slice)
```
...
```csharp
public static Boolean operator ==(ReadOnlySpanBuffer left, ReadOnlySpanBuffer right)
```

#### Parameters

`left` [ReadOnlySpanBuffer](OceanApocalypseStudios.RSML.Sources.ReadOnlySpanBuffer.md)

`right` [ReadOnlySpanBuffer](OceanApocalypseStudios.RSML.Sources.ReadOnlySpanBuffer.md)
