---
id: "OceanApocalypseStudios.RSML.Sources.IBuffer.md"
...
```csharp
public interface IBuffer : IReadOnlyBuffer, ISource, IDisposable, IEquatable<IReadOnlyBuffer?>, IEquatable<Char[]?>, IEquatable<String?>, IEquatable<ReadOnlyMemory<Char>>
```
