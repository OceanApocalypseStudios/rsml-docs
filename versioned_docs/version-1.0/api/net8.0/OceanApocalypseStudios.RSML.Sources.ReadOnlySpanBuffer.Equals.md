# <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_System_Object_"></a> Method Equals

Namespace: [OceanApocalypseStudios.RSML.Sources](OceanApocalypseStudios.RSML.Sources.md)  
Assembly: RSML.dll  

## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_System_Object_"></a> Equals\(Object?\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_System_Char___"></a> Equals\(Char\[\]?\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_OceanApocalypseStudios_RSML_Sources_IReadOnlyBuffer_"></a> Equals\(IReadOnlyBuffer?\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_System_ReadOnlyMemory_System_Char__"></a> Equals\(ReadOnlyMemory<Char\>\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_System_ReadOnlySpan_System_Char__"></a> Equals\(ReadOnlySpan<Char\>\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_"></a> Equals\(ReadOnlySpanBuffer\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_ReadOnlySpanBuffer_Equals_System_String_"></a> Equals\(String?\)
