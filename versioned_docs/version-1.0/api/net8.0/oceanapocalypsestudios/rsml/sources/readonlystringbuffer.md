---
id: net8.0-readonlystringbuffer
...
```csharp
public class ReadOnlyStringBuffer : IReadOnlyBuffer, ISource, System.IDisposable, System.IEquatable`1[[OceanApocalypseStudios.RSML.Sources.IReadOnlyBuffer, RSML, Version=3.0.0.0, Culture=neutral, PublicKeyToken=null]], System.IEquatable`1[[System.Char[], System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], System.IEquatable`1[[System.String, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], System.IEquatable`1[[System.ReadOnlyMemory`1[[System.Char, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], OceanApocalypseStudios.RSML.Cache.ISupportsCache
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md)<br>
...
&gt; [!TIP]
 &gt; If you wish to avoid allocating this buffer, it's recommended to take a look at [ReadOnlySpanBuffer](./oceanapocalypsestudios/rsml/sources/readonlyspanbuffer.md).
...
Always returns `true`, as [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md) only
...
[ReadOnlyStringBuffer.LineCount](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#linecount) automatically builds cache if
 no cached data exists. No [ReadOnlyStringBuffer.BuildCache()](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#buildcache) calls
 are necessary.
...
Initializes a new [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md)
 with a string.
...
Initializes a new [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md)
 by allocating a string from a [ReadOnlySpan&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/api/system.readonlyspan-1).
...
`content` [Byte[]](https://learn.microsoft.com/en-us/dotnet/api/system.byte)<br>
...
The encoding to use when decoding `content`.
 Use `null` for the [Encoding.Default](https://learn.microsoft.com/en-us/dotnet/api/system.text.encoding.default) encoding.
...
```csharp
public ReadOnlyStringBuffer(Byte* contentPtr, int byteCount, Encoding? encoding = null)
```

#### Parameters

`contentPtr` [Byte*](https://learn.microsoft.com/en-us/dotnet/api/system.byte*)<br>
The pointer referecing the array of bytes to use for the buffer.

`byteCount` [Int32](https://learn.microsoft.com/en-us/dotnet/api/system.int32)<br>
The amount of bytes in the array referenced by `contentPtr`.

`encoding` [Encoding](https://learn.microsoft.com/en-us/dotnet/api/system.text.encoding)?<br>
The encoding to use when decoding `contentPtr`.
 Use `null` for the [Encoding.Default](https://learn.microsoft.com/en-us/dotnet/api/system.text.encoding.default) encoding.
...
&gt; [!NOTE]
 ...
 &gt; - If the index is EOF ([ReadOnlyStringBuffer.Length](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#length)), then the output is always 0 and `isCrLf` is always `false`.
 &gt; - If the index is the last ([ReadOnlyStringBuffer.Length](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#length) - 1), then the output is always 0.
 &gt; [!NOTE]
...
&gt; [!NOTE]
 ...
 &gt; If the index is EOF ([ReadOnlyStringBuffer.Length](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#length)), then the output is always 0.
 &gt; [!NOTE]
 ...
 &gt; [ReadOnlyStringBuffer.Length](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#length), which is also the EOF index.
...
&gt; [!NOTE]
 ...
 &gt; EOF is considered a 0-character sequence in line N, where N is [ReadOnlyStringBuffer.LineCount](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#linecount).
...
&gt; [!IMPORTANT]
 &gt; Unlike with other [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md) methods, this one
 &gt; does not follow EOF conventions and, because of that, does not accept the 
 &gt; EOF index (index at [ReadOnlyStringBuffer.Length](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md#length)), because it is not
...
```csharp
public bool Equals(IReadOnlyBuffer? other)
```
...
`left` [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md)<br>

`right` [ReadOnlyStringBuffer](./oceanapocalypsestudios/rsml/sources/readonlystringbuffer.md)<br>
