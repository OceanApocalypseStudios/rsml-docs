# <a id="OceanApocalypseStudios_RSML_Sources_SourceLocation_Equals_System_Object_"></a> Method Equals

Namespace: [OceanApocalypseStudios.RSML.Sources](OceanApocalypseStudios.RSML.Sources.md)  
Assembly: RSML.dll  

## <a id="OceanApocalypseStudios_RSML_Sources_SourceLocation_Equals_System_Object_"></a> Equals\(Object?\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_SourceLocation_Equals_OceanApocalypseStudios_RSML_Sources_SourceLocation_"></a> Equals\(SourceLocation\)
...
## <a id="OceanApocalypseStudios_RSML_Sources_SourceLocation_Equals_System_Int32_"></a> Equals\(Int32\)
