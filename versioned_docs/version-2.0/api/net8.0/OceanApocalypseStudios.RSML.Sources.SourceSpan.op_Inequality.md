# <a id="OceanApocalypseStudios_RSML_Sources_SourceSpan_op_Inequality_OceanApocalypseStudios_RSML_Sources_SourceSpan_OceanApocalypseStudios_RSML_Sources_SourceSpan_"></a> Operator operator \!=

Namespace: [OceanApocalypseStudios.RSML.Sources](OceanApocalypseStudios.RSML.Sources.md)  
Assembly: RSML.dll  

## <a id="OceanApocalypseStudios_RSML_Sources_SourceSpan_op_Inequality_OceanApocalypseStudios_RSML_Sources_SourceSpan_OceanApocalypseStudios_RSML_Sources_SourceSpan_"></a> operator \!=\(SourceSpan, SourceSpan\)
